...
include_once("../classes/register.classes.php");
    ...
    class RegisterContr extends Register{
        ...
        public function registerReportero(){
            //validaciones
            if($this->emptyInputs() == false){
                //echo 'rip en los inputs';
                //header("location: ../registro.php?error=emptyInputs");
            ...
            $this->registerReporter($this->user,$this->Alias,$this->email, $this->pwd);

           
        }

        public function UpdateReporteroA(){
            //validaciones
            if($this->emptyInputs() == false){
                //echo 'rip en los inputs';
                //header("location: ../registro.php?error=emptyInputs");
            ...
            $this->UpdateReporter($this->user,$this->Alias,$this->email, $this->pwd);
